...
include "header.php";
?>
<title>DTD Fashion | Contact_us</title>
<!-- header end --> 
					...
					<div class="contact-box-wrap">
						<div class="contact-box">
						  ...
						  <div class="contact-box-item">
							...
							<div class="link-inline"><a href="#"><i class="fa fa-phone"></i> 8600226911</a></div>
						  </div>
						  <div class="contact-box-item">
							<p class="contact-box-title">E-mail</p>
							<div class="link-inline"><a href="#"><i class="fa fa-envelope-o"></i>dtdfashion7@gmail.com</a></div>
						  </div>
						  <div class="contact-box-item">
							<p class="contact-box-title">Address</p>
							<div class="link-inline link-inline-top"><a href="#"><i class="fa fa-map-marker"></i>133 Begum Peth , solapur</a></div>
						  </div>
						</div>
					</div>
				</div>
